            ...
            describe("When registerRoute is called with a valid method, path, and callback", () => {
                describe("When the path has no path params", () => {
                    it("Then the router is updated with the new route", () => {
                        const cb = () => 'test'
                        const _router = Router.registerRoute('GET', '/test/path', cb)
                        const expected = [
                            {
                                "callback": cb,
                                "method": "GET", 
                ...
                describe("When the path has one path param", () => {
                    it("Then the router is updated with the new route", () => {
                        const cb = () => 'test'
                        const _router = Router.registerRoute('GET', '/test/path/:id', cb)
                        const expected = [
                            {
                                "callback": cb,
                                "method": "GET", 
            ...
            describe("When matchedRoute is called with a valid method and path", () => {
                describe("When there are no routes in the router", () => {
                    it("Then an empty route object is returned", () => {
                        const expected = {}
                        const matchedRoute = Router.matchedRoute("GET", '/test/path')
                ...
                describe("When no matching route exists in the router", () => {
                    it("Then an empty route object is returned", () => {
                        ...
                        const expected = {}
                        const matchedRoute = Router.matchedRoute("POST", '/test/path')
                        expect(matchedRoute).toStrictEqual(expected)
                    })
                })
                describe("When no matching route exists in the router and the path has a param", () => {
                    it("Then an empty route object is returned", () => {
                        ...
                        const expected = {}
                        const matchedRoute = Router.matchedRoute("POST", '/test/path/:id')
                        expect(matchedRoute).toStrictEqual(expected)
                    })
                })
        ...
        describe("getRouter()", () => {
            ...
            describe("When getRouter is called", () => {
                it("Then the router is returned", () => {
                    ...
                    const expected = [
                        {
                            "callback": cb, "method": "GET", "params": [{"index": 2, "key": "id"}], "path": "/test/path/:id", "pathArray": ["test", "path", ":id"]
                        }, 
                        {
                            "callback": cb, "method": "POST", "params": [{"index": 2, "key": "id"}], "path": "/test/path/:id", "pathArray": ["test", "path", ":id"]
                        }
                    ]
